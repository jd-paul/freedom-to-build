...
export function Cyclist({ helmetColor }: CyclistProps) {
  ...
  useFrame((_, rawDelta) => {
    ...
    // Conform to terrain
    const groundY = terrainHeightAt(g.position.x, g.position.z)
    g.position.y = THREE.MathUtils.lerp(g.position.y, groundY + 0.5, delta * 10)
