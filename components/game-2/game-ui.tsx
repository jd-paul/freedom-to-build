    ...
    <>
      ...
      {!started && (
        <div className="absolute inset-0 z-20 flex items-center justify-center bg-black/50 p-6">
          <div className="w-full max-w-lg rounded-2xl border-4 border-black bg-[#f0f9ff] p-8 text-center shadow-[8px_8px_0_0_#000]">
            <p className="mb-2 font-sans text-xs font-bold uppercase tracking-[0.3em] text-[#0284c7]">
              Ride London Clean
            </p>
            ...
            <p className="mb-6 font-sans text-sm leading-relaxed text-black/80">
              ...
              <strong className="text-black">arrow keys</strong>. Ride the valley, climb the slopes, and spot Big Ben from the peaks.
            </p>
            ...
            <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
              <button
                type="button"
                onClick={start}
                className="rounded-xl border-4 border-black bg-[#0284c7] px-10 py-3 font-sans text-sm font-black uppercase tracking-widest text-white shadow-[5px_5px_0_0_#000] transition-transform hover:scale-105 active:translate-x-[2px] active:translate-y-[2px] active:shadow-none"
              >
                PLAY
              </button>
              <Link
